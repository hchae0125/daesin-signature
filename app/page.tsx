...
export default function Page() {
  ...
  const works: WorkItem[] = [
    ...
    { id: 3, title: "중앙감속기,차이니즈 퓨전 레스토랑", location: "성수동, 서울", category: "Cast Brass", material: "샌드캐스트 · 핸드 에이징 주물", bgImg: "/asset/적동부식 001 interior.PNG", detailImg: "/asset/적동부식 001.jpg" },
    { id: 4, title: "키요이 스키야키, 일식 레스토랑", location: "서울대입구, 서울", category: "Stainless/Gold", material: "스테인리스 · 브러시드 골드", bgImg: "/asset/주물간판001 exterior.png", detailImg: "/asset/주물간판001.jpg" },
