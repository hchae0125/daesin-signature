...
export default function PortfolioSection({ onWorkSelect }: PortfolioSectionProps) {
  ...
  return (
    <section id="portfolio" className="max-w-6xl mx-auto px-6 py-16 scroll-mt-12">
      ...
      <div className="flex flex-col items-center my-12 gap-3">
        ...
        <div className="text-[11px] text-[#8C8A83] bg-[#E6E4DD]/40 px-4 py-2 rounded-xl border border-[#E6E4DD]/60 text-center max-w-2xl leading-relaxed">
